...
export class RealEstate {
  ...
  public set appraisedValues(value: number) {
    this._appraisedValues = value
  }
  ...
  public static deserialize(assetJSON: Uint8Array): RealEstate {
    try {
      ...
      doFail(`Deserialize error DATA_ERROR: ${err}`)
    }
  }
